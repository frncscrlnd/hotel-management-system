...
def elimina_prenotazione(nome):
    for prenotazione in Prenotazione:
        if prenotazione["nome"] == nome:
            Prenotazione.remove(prenotazione)
            print(f"La prenotazione di {nome} è stata eliminata.")
            return
    print(f"La prenotazione di {nome} non è stata trovata.")
